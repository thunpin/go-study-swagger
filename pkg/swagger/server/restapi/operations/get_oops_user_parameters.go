...
// NewGetOopsUserParams creates a new GetOopsUserParams object
// no default values defined in spec.
func NewGetOopsUserParams() GetOopsUserParams {

	return GetOopsUserParams{}
}

// GetOopsUserParams contains all the bound params for the get oops user operation
// typically these are obtained from a http.Request
//
// swagger:parameters GetOopsUser
type GetOopsUserParams struct {
...
func (o *GetOopsUserParams) bindUser(rawData []string, hasKey bool, formats strfmt.Registry) error {
	var raw string
	if len(rawData) > 0 {
